"""Run Swarmalator simulations and parameter sweeps."""
...
def save_final_state(
    ...
    Args:
        swarm: Swarm instance to read parameters and observables from.
...
def run_once(
    ...
    Args:
        ...
        burnin: Burn-in steps before sampling (currently unused).
        sample_every: Logging interval for trajectory snapshots.
