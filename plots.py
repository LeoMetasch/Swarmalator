...
if __name__ == "__main__":
    plot_phase_heatmap(csv_path='N100 10step sampling.csv', out_path="plots/heatmap_state_n_100_10.png")
    plot_S_heatmap(csv_path='N100 10step sampling.csv', out_path="plots/heatmap_S_n_100_10.png")
    # plot_transient_time_summary(csv_path="./results_data/transient_times_summary.csv")